...
RAW_DIR = (PROJECT_ROOT / "Data" / "Raw" / "FBref").resolve()
TM_RAW_DIR = (PROJECT_ROOT / "Data" / "Raw" / "Transfermarkt").resolve()
...
def run_transfermarkt_block() -> None:
    ...
    try:
        scrape_transfermarkt(output_folder=TM_RAW_DIR)
    except Exception as e:
    ...
    try:
        build_market_value_lookup(TM_RAW_DIR, PROCESSED_DIR, df_fbref)
    except Exception as e:
